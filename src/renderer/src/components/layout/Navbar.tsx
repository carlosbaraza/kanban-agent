    ...
    <nav className={styles.navbar}>
      ...
      <div className={styles.navGroup}>
        ...
        <button
          ...
          onClick={async () => {
            try {
              const wt = await window.api.worktreeCreate()
              await window.api.workspaceAddProject(wt.path)
              const { loadOpenProjects, loadWorktrees, switchProject } = useWorkspaceStore.getState()
              await loadOpenProjects()
              await loadWorktrees()
              await switchProject(wt.path)
              const { loadProjectState } = useTaskStore.getState()
          ...
          title="New Worktree"
          data-testid="create-worktree-nav-button"
        >
          {/* Git branch icon */}
